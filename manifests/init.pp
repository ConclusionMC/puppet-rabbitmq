...
class rabbitmq(
  ...
  $config_ranch                                                                            = $rabbitmq::params::config_ranch,
  ...
  $package_erlang_ensure                                                                    = $rabbitmq::params::package_erlang_ensure,
  $package_gpg_key                                                                = $rabbitmq::params::package_gpg_key,
  $package_name                                                             = $rabbitmq::params::package_name,
  $package_erlang_name                                                             = $rabbitmq::params::package_erlang_name,
  $package_source                                                                 = undef,
  $package_provider                                                               = undef,
  $repos_ensure                                                                            = $rabbitmq::params::repos_ensure,
  $manage_python                                                                           = $rabbitmq::params::manage_python,
  ...
  $ssl_management_verify                                         = $rabbitmq::params::ssl_management_verify,
  $ssl_management_fail_if_no_peer_cert                                                     = $rabbitmq::params::ssl_management_fail_if_no_peer_cert,
  $ssl_versions                                                                    = undef,
  ...
  $ipv6                                                                                    = $rabbitmq::params::ipv6,
  $inetrc_config                                                                            = $rabbitmq::params::inetrc_config,
  $inetrc_config_path                                                         = $rabbitmq::params::inetrc_config_path,
  $ssl_erl_dist                                                                            = $rabbitmq::params::ssl_erl_dist,
  $rabbitmqadmin_package                                                          = $rabbitmq::params::rabbitmqadmin_package,
  $archive_options                                                                           = $rabbitmq::params::archive_options,
